  ...
  return (
    <section className="it-flow-section">
      ...
      <div className="it-flow-cards">
        ...
        {/* Clean raw SVG path vector definitions inside defs for WebGL 3D Ribbon Extrusion sampling */}
        <svg className="it-network-paths w-embed" viewBox="0 0 740 2000" preserveAspectRatio="xMidYMid slice" aria-hidden="true" style={{ position: 'absolute', width: '1px', height: '1px', opacity: 0, pointerEvents: 'none' }}>
          <defs>
